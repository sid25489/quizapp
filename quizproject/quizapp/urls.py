...
urlpatterns = [
    ...
    # NEW PRO ROUTES (Route Transformation)
    ...
    path('quiz/add/', views.add_question, name='add_question'),
    path('quiz/validation-results/', views.validation_results, name='validation_results'),

    path('quiz/<int:quiz_id>/', views.quiz_detail, name='quiz_detail'),
    path('quiz/<int:quiz_id>/start/', views.start_quiz, name='start_quiz'),
    path('quiz/<int:quiz_id>/generate_more/', views.generate_more, name='generate_more'),
    path('quiz/<int:quiz_id>/remove_questions/', views.remove_questions, name='remove_questions'),
